...
CHAVE_API = "antigo token revogado"
...
@bot.message_handler(commands=["Como_passar_pelo_encurtador_ShrtFly"])
def Como_passar_pelo_encurtador_ShrtFly(mensagem):
    bot.send_message(mensagem.chat.id, "https://youtu.be/hI6D2yaySgY")
...
def h(mensagem):
    ...
    /Como_passar_pelo_encurtador_ShrtFly
    """
    bot.send_message(mensagem.chat.id, texto)
...
def op7(mensagem):
    bot.send_message(mensagem.chat.id, "Mods no app Enigma Pro https://vm.tiktok.com/ZMLDNactb/")
...
def responder(mensagem):
    ...
    Por quê? Leia: https://dev--my-project.jetrom.autocode.gg/hello.html
    ...
    Escolha uma opção para continuar (Clique no item):
     ...
     /op7 Recurso novo (Atualização em tempo real)
     /h Guia Enigma (yt)
     """
